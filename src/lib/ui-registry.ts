...
export const UI_OVERRIDES: Record<string, UIOverride> = {
  ...
  "finance_review_notes": {
    "customData": [
      ...
      {
        "text": "تغییر نام ضمائم در قراردادهای تهاتری تایید شده: در صورت تایید قرارداد تهاتر، عنوان فیلد ضمائم به 'ضمائم نهایی آرین پارس/هدلینگ' تغییر کرده و الزامی (required) میگردد. توجه نمایید بر اساس مالک فعالیت تغییر می کند یعنی اگر تیم پارس کار را انجام دادن نوشته شود ضمائم نهایی آرین پارس",
  ...
  "بررسی درخواست توسط ... (کپی)": {
    "text": "بررسی ذینفع مالی پارس/هلدینگ"
  },
